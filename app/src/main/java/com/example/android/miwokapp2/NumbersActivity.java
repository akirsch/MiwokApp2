...
import com.example.android.miwokapp2.R;
import com.example.android.miwokapp2.Word;
import com.example.android.miwokapp2.WordAdapter;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(NumbersActivity.this, audioTrackResourceId);
                    mMediaPlayer.start();
